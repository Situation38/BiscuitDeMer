...
namespace TestBiscuitDeMer
{
    ...
    {
                /*Les tests nous conduisent a la redaction dun code clean
                 * beaucoup plus generique.
                 * 
                 * 
                 * Test Okey    
                 */
        ...
        //quil nous renvoie deux nombres concatenes en sortie
        {
            //ARRANGE
            var bDeMer = new BiscuitDemer();

            //ACT+ASSERT
            //on a 30 et on veut que en sortie de notre methode genere on est "12"

            Assert.AreEqual("12", bDeMer.Genere(1,2));
        }


        public void doisRetourner_12Biscuit_SiLesNombres1A3()
        //On passe des nombres dans une sequence en parametre et on aimerait
        //quil nous renvoie en sortie leurss valeurs en string concatenes
        {
            //ARRANGE
            var bDeMer = new BiscuitDemer();

            //ACT+ASSERT
            //De 1 a 3 et on veut que en sortie de notre methode genere on est "12Biscuit"

            Assert.AreEqual("12Biscuit", bDeMer.Genere(1, 3));
        }

        public void doisRetourner_12Biscuit4Demer_SiLesNombres1A5()
        //On passe des nombres dans une sequence en parametre et on aimerait
        ///quil nous renvoie en sortie leurs valeurs en string concatenes
        {
            //ARRANGE
            var bDeMer = new BiscuitDemer();

            //ACT+ASSERT
            //De 1 a 5et on veut que en sortie de notre methode genere on est "BiscuitDeMer"
            Assert.AreEqual("12Biscuit", bDeMer.Genere(1, 5));
        }


        public void doisRetourner_12Biscuit4DeMerBiscuit78BiscuitDemer11Biscuit1314BiscuitDeMer_SiLesNombres1A15()
        //On passe des nombres dans une sequence en parametre et on aimerait
        ///quil nous renvoie en sortie leurs valeurs en string concatenes
        {
            //ARRANGE
            ...
            //ACT+ASSERT
            //De 1 a 5et on veut que en sortie de notre methode genere on est "BiscuitDeMer"
            Assert.AreEqual("12Biscuit4DeMerBiscuit78BiscuitDemer11Biscuit1314BiscuitDeMer"
                , bDeMer.Genere(1, 15));
        }
